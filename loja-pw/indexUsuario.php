...
$stmt = $pdo->query('SELECT idusuario, nome, senha, foto FROM lojaphp.usuario;');

while ($linha = $stmt->fetch(PDO::FETCH_ASSOC)) {
   
echo "<p><font color='#ffffff'> ID: {$linha['idusuario']} - Nome: {$linha['nome']} - Senha: {$linha['senha']} - Foto: {$linha['foto']}  </font>";}
?>
</div> 
...
<!--CADASTRAR PRODUTO-->
<!--produto-->
<form class= "form-cadastro"  method="post" action = "cad_usuario.php" id= "formCad" name = "formCad">
<!--<fieldset id= "fie">-->
...
<!--</fielset>-->
       ...
       <form class="form-update"  method="post" action="update_usuario.php" id="formCad" name="formCad">
        ...
        <div align="center">
            ...
            <h3>Atualizar produto</h3>
                ...
                <tr>
                   ...
                   <tr>
                <td><div align="rigth">SENHA:</div></td>
...
<!--user-->
<form class="form-delete" method="post" action="del_usuario.php" id="formDel" name="formDel">
